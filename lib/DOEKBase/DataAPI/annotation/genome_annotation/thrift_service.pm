...
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::thrift_service_get_feature_ids_args->mk_accessors( qw( token ref filters group_type ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{filters} = new DOEKBase::DataAPI::annotation::genome_annotation::Feature_id_filters();
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new DOEKBase::DataAPI::annotation::genome_annotation::Feature_id_mapping();
...
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::thrift_service_get_proteins_args->mk_accessors( qw( token ref ) );
...
sub process_get_taxon {
    ...
    if ($@) {
      ...
      $output->writeMessageBegin('get_taxon', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_assembly {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_assembly', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_types {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_types', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_type_descriptions {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_type_descriptions', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_type_counts {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_type_counts', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_ids {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_ids', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_features {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_features', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_proteins {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_proteins', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_locations {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_locations', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_publications {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_publications', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_dna {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_dna', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_functions {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_functions', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_feature_aliases {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_feature_aliases', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_cds_by_gene {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_cds_by_gene', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_cds_by_mrna {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_cds_by_mrna', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_gene_by_cds {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_gene_by_cds', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_gene_by_mrna {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_gene_by_mrna', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_mrna_by_cds {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_mrna_by_cds', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
...
sub process_get_mrna_by_gene {
    ...
    if ($@) {
      $@ =~ s/^\s+|\s+$//g;
      my $err = new TApplicationException("Unexpected Exception: " . $@, TApplicationException::INTERNAL_ERROR);
      $output->writeMessageBegin('get_mrna_by_gene', TMessageType::EXCEPTION, $seqid);
      $err->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
      $@ = undef;
