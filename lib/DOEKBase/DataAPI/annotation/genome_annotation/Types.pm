...
package DOEKBase::DataAPI::annotation::genome_annotation::ServiceException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::ServiceException->mk_accessors( qw( message stacktrace inputs ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::AuthorizationException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::AuthorizationException->mk_accessors( qw( message stacktrace ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::AuthenticationException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::AuthenticationException->mk_accessors( qw( message stacktrace ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::ObjectReferenceException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::ObjectReferenceException->mk_accessors( qw( message stacktrace ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::AttributeException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::AttributeException->mk_accessors( qw( message stacktrace ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::TypeException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::TypeException->mk_accessors( qw( message stacktrace valid_types ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::Region;
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::Region->mk_accessors( qw( contig_id strand start length ) );
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem27 = undef;
            $elem27 = new DOEKBase::DataAPI::annotation::genome_annotation::Region();
...
package DOEKBase::DataAPI::annotation::genome_annotation::Feature_id_mapping;
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::Feature_id_mapping->mk_accessors( qw( by_type by_region by_function by_alias ) );
...
package DOEKBase::DataAPI::annotation::genome_annotation::Feature_data;
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::Feature_data->mk_accessors( qw( feature_id feature_type feature_function feature_aliases feature_dna_sequence_length feature_dna_sequence feature_md5 feature_locations feature_publications feature_quality_warnings feature_quality_score feature_notes feature_inference ) );
      ...
      /^8$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem144 = undef;
            $elem144 = new DOEKBase::DataAPI::annotation::genome_annotation::Region();
...
package DOEKBase::DataAPI::annotation::genome_annotation::Protein_data;
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::Protein_data->mk_accessors( qw( protein_id protein_amino_acid_sequence protein_function protein_aliases protein_md5 protein_domain_locations ) );
