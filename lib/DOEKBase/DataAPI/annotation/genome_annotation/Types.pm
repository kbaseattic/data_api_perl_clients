...
package DOEKBase::DataAPI::annotation::genome_annotation::AssemblyContig;
use base qw(Class::Accessor);
DOEKBase::DataAPI::annotation::genome_annotation::AssemblyContig->mk_accessors( qw( contig_id sequence length gc_content md5 name description is_complete is_circular ) );
